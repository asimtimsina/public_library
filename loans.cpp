...
extern books boks;
  ...
  /////////////////////////////////////////////////////
    ...
    LoanStatus status;
      ...
      boks.bookstatuschange(Book,Out);
...
bool loans::checkLoan(int id){ // function that checks whether a loan id already exits or not
            ...
            int duedate = Loans_list[i].getDuedate();
              ...
              if(dif_time >0){
                ...
                pat.changefineBal(id,fine);
                     ...
                     boks.bookstatuschange(Loans_list[i].getBook_id(),In);
         ...
         bool check=false; 
              ...
              cin  >> id ;
               ...
               for (int i = 0 ; i < Loan_count ; i ++){
                  if(Loans_list[i].getLoan_id()==id){
                    check =true;
                    boks.bookstatuschange(Loans_list[i].getBook_id(),Lost);

                    int patron = Loans_list[i].getPatron_id();
                    float cost =boks.getcostofbook(patron) ;
  ...
  /////////////////////////////////////////////////////
    ...
    cout <<left <<setw(15) << Loans_list[i].getLoan_id() << setw(12) << Loans_list[i].getPatron_id() <<setw(14) << Loans_list[i].getBook_id() <<setw(15) <<  current  << duedate <<endl ;
  }
    }
...
cout <<"Total Loans Count: " << Loan_count << endl; 
    ...
    cout <<left <<setw(15) << Loans_list[i].getLoan_id() << setw(12) << Loans_list[i].getPatron_id() <<setw(14) << Loans_list[i].getBook_id() <<setw(15) <<  current  << duedate  ;
  }
